 ...
 * Botón flotante que permanece visible en scroll para contacto rápido
 */
    ...
    <>
      {isVisible && (
        <motion.a
          ...
          className="fixed right-6 bottom-6 z-50 flex items-center justify-center w-16 h-16 bg-linear-to-br from-green-500 to-green-600 rounded-full shadow-2xl shadow-green-500/50 hover:shadow-green-500/70 transition-all group"
